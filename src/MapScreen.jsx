...
const CITIES = [
    ...
    },
    {
        ...
        xpNeeded: 150, x: 11.4, y: 10.7, width: 125,
    ...
    },
    {
        ...
        xpNeeded: 300, x: 18.7, y: 81.8, width: 111,
    ...
    },
    {
        ...
        xpNeeded: 500, x: 43, y: 14.4, width: 115.5,
    ...
    },
    {
        ...
        xpNeeded: 750, x: 56.2, y: 86.2, width: 118,
    ...
    },
    {
        ...
        xpNeeded: 1000, x: 71.9, y: 26.3, width: 121,
                ...
                {CITIES.map((city, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            style={{ left: `${city.x}%`, top: `${city.y}%`, width: `${city.width}px` }}
